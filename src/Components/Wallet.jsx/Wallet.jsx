        ...
        <>
            <div className="flex flex-col xl:flex-row items-center justify-center gap-7 p-4 max-w-[1024px] mx-auto">
                ...
                <img
                    src={cardImage}
                    alt="Card"
                    className="rounded-xl shadow-lg xl:w-[527px] xl:h-[279px] w-[300px] h-[160px]"
                />

                {/* Button Section */}
                <div className="space-y-5 w-full">
                    {/* Selected Button */}
                    <button className="flex items-center justify-between xl:w-[454px] xl:h-[78px] w-full h-[60px] bg-[#262630] text-white text-[16px] font-bold rounded-2xl px-4">
                    ...
                    {/* Unselected Buttons */}
                    <button className="flex items-center justify-between xl:w-[454px] xl:h-[78px] w-full h-[60px] bg-[#F1F1F1] text-[#C4C4C4] text-[16px] font-bold rounded-2xl px-4">
                        <span className="flex items-center gap-2">
            ...
            <div className="flex flex-col items-center gap-4 p-4 max-w-[1024px] mx-auto">
                ...
                <div className="flex flex-col md:flex-row gap-4 md:gap-8 w-full">
                    ...
                    <input
                        ...
                        className="w-full md:w-[313px] h-[60px] bg-[#F1F1F1] text-[#C4C4C4] text-[14px] font-bold rounded-xl px-4 focus:outline-none focus:border-[1.5px] focus:border-[#FF2A2A]"
                    />
                    ...
                    {/* Date Input */}
                    <div className="relative flex items-center w-full md:w-[313px] h-[60px] bg-[#F1F1F1] rounded-xl">
                ...
                <div className="flex flex-col md:flex-row gap-3 items-center w-full">
                    ...
                    <div className="hidden md:flex relative flex items-center w-full md:w-[683px] h-[60px] bg-[#F1F1F1] rounded-xl px-4">
                    ...
                    <div className="flex md:hidden flex-col items-end gap-1 w-full">
                        ...
                        <div className="flex items-center w-full h-[60px] bg-[#F1F1F1] rounded-xl px-4">
                            <div className="flex-1 flex flex-row-reverse items-baseline gap-[24px] text-[#D9D9D9]">
                                <input
                                    type="text"
                                    maxLength="4"
                ...
                <div className="flex flex-col items-center gap-4 w-full">
                    ...
                    <div className="hidden md:flex flex flex-col md:flex-row items-center justify-between w-full md:w-[1010px] h-[60px] bg-[#F1F1F1] rounded-xl p-2">
                        <div className="w-full md:w-[313px] h-[60px] bg-[#565662] flex items-center justify-center rounded-xl text-white text-[14px]">
                    ...
                    <div className="flex md:hidden flex-col items-end gap-1 w-full">
                        ...
                        <div className="flex items-center w-full h-[60px] bg-[#F1F1F1] rounded-xl px-4">
                            <div className="flex items-center justify-center w-[60px] h-[60px] bg-[#262630] rounded-xl text-white text-[14px] order-last ml-[-4%]">
                                IR
                            </div>
                ...
                <div className="mt-2 w-full flex justify-start max-w-[1024px] mx-auto">
                    <button className="w-full md:w-[130px] md:h-[60px] h-[40px] w-[120px] bg-[#1FBC42] text-white text-[14px] font-bold rounded-xl">
                        ارسال اطلاعات
                    </button>
                </div>
            </div>
